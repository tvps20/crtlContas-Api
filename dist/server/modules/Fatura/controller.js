...
var FaturaController = /** @class */ (function () {
    ...
    FaturaController.prototype.getAll = function (req, res) {
        service_1.default
            ...
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Erro ao buscar todas as faturas'));
    };
    FaturaController.prototype.createCartao = function (req, res) {
        service_1.default.create(req.body)
            ...
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Erro ao inserir nova fatura'));
    };
    FaturaController.prototype.getById = function (req, res) {
        var faturaId = parseInt(req.params.id);
        service_1.default.getById(faturaId)
            .then(_.partial(handlers_1.default.onSuccess, res, HttpStatus.OK))
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Fatura não encontrada'));
    };
    FaturaController.prototype.updateCartao = function (req, res) {
        ...
        service_1.default.update(faturaId, props)
            .then(_.partial(handlers_1.default.onSuccess, res, HttpStatus.OK))
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Falha ao atualizar fatura'));
    };
    FaturaController.prototype.deleteCartao = function (req, res) {
        var faturaId = parseInt(req.params.id);
        service_1.default.delete(faturaId)
            .then(_.partial(handlers_1.default.onSuccess, res, HttpStatus.OK))
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Erro ao excluir fatura'));
    };
