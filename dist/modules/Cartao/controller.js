...
var CartaoController = /** @class */ (function () {
    ...
    CartaoController.prototype.getAll = function (req, res) {
        service_1.default
            ...
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Erro ao buscar todos os cartões'));
    };
    CartaoController.prototype.createCartao = function (req, res) {
        service_1.default.create(req.body)
            ...
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Erro ao inserir novo cartão'));
    };
    CartaoController.prototype.getById = function (req, res) {
        var cartaoId = parseInt(req.params.id);
        service_1.default.getById(cartaoId)
            .then(_.partial(handlers_1.default.onSuccess, res, HttpStatus.OK))
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Cartão não encontrado'));
    };
    CartaoController.prototype.updateCartao = function (req, res) {
        ...
        service_1.default.update(cartaoId, props)
            .then(_.partial(handlers_1.default.onSuccess, res, HttpStatus.OK))
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Falha ao atualizar cartão'));
    };
    CartaoController.prototype.deleteCartao = function (req, res) {
        var cartaoId = parseInt(req.params.id);
        service_1.default.delete(cartaoId)
            .then(_.partial(handlers_1.default.onSuccess, res, HttpStatus.OK))
            .catch(_.partial(handlers_1.default.onError, res, HttpStatus.INTERNAL_SERVER_ERROR, 'Erro ao excluir cartão'));
    };
