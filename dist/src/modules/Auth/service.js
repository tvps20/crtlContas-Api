        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, service_1.default.getByEmail(email)];
                    case 2:
                        user = _b.sent();
                        response_handlers_1.default.authSuccess(res, { email: email, password: password }, user);
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _b.sent();
                    ...
                    case 5:
                        response_handlers_1.default.onError(res, HttpStatus.UNAUTHORIZED, 'Necessário informar email e senha', 'no-credentials');
                        _b.label = 6;
